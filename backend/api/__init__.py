"""
Welcome to the documentation for the Fabricare API!
...
[project's source code](https://github.com/Usool-Data-Science/FabriCare/tree/main/backend/api) using
...
If you are running Fabricare API yourself while developing your front end,
...
| `MAIL_DEFAULT_SENDER` | `donotreply@fabricare.example.com` | The default sender to use for emails. |
