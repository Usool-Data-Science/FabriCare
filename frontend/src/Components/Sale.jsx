    ...
    return (
        <Body>
            <div className="bg-inherit mt-4">
                <div className="lg:m-10 border border-gray-100 p-4 flex flex-col lg:flex-row gap-2 items-center justify-between lg:mx-16 xl:mx-32">
                    ...
                    {/* Details */}
                    <div className="sm:mx-9 lg:w-[30%] lg:flex lg:flex-col justify-between font-courier text-ellipsis">
                        ...
                        {apiData.days_left > 0 ? <>
                            {/* Composition */}
                            <p className='text-base mb-4'>Composition: {apiData.composition}</p>
                            {/* Color */}
                            <p className='text-base mb-4'>Color: {apiData.color}</p>
                            {/* Size Guide */}
                            ...
                            <div className='flex gap-4'>
                                {apiData?.sizes?.map((size) => (
                                    <div key={size} className='bg-white py-1 px-2 text-lg text-black font-bold w-8 min-w-fit grid place-content-center'>
                                        {size.toUpperCase()}
                                    </div>
                                ))}
                            </div>
                            ...
                            <p className='bg-white py-1 px-2 text-lg text-black font-bold w-8 min-w-fit grid place-content-center'>
                                1
                            </p>
                            {/* Price */}
                            <p className='mt-4 text-base'>Price: {apiData.price}</p>
                            <button
